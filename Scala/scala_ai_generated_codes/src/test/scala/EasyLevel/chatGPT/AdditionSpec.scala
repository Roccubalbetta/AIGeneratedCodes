...
class AdditionSpec extends AnyFlatSpec with Matchers {
  ...
  "addNumbers" should "return the correct sum for positive numbers" in {
    val result = Addition.addNumbers(5, 7)
